...
class TestData:
    username = "Admin"
    password = "admin123"
    password_no_vaild = 'Invalid password'
    firstname = 'sankaran'
    middle_name = 'kutty'
    last_name = 'm'
    employee_name = 'shkutty'
    other_id = '1999'
    driver_lic_no = '070799'
    licence_expiry_date = '2024-29-10'
    DOB = '1999-07-07'
...
class TestSelectors:
    ...
    martial_status_0 = ("/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[''3]/div[1]/div["
                        "2]/div/div[2]/div/div/div[2]/i")

    martial_status_1 = ('//*[@id="app"]/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div['
